...
serve(async (req) => {
  ...
  try {
    ...
    // Note: We removed payment rate limiting - users should be able to retry payments freely
    // The actual payment is handled by Stripe which has its own fraud prevention
    ...
    const origin = req.headers.get("origin") || "https://trustworthycheck.com";

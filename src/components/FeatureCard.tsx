...
export function FeatureCard({ icon: Icon, emoji, title, description, index }: FeatureCardProps) {
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-3xl p-8 border-2 border-border/60 shadow-lg hover:shadow-2xl hover:border-primary/30 transition-all duration-300"
    >
